import { ADD_REQUEST_BODY_API, ADD_REQUEST_FILE_API, EDIT_REQUEST_BODY_API, GET_REQUEST_API } from "./APIRequests";
...
export function editNodeRequest(b){
    return EDIT_REQUEST_BODY_API('ImageAnswers/EditAnswerImageOneStep', b, true)
}
